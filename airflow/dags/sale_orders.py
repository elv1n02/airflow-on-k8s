...
def mysql_to_parquet_and_store_in_minio():
    ...
    mysql_hook = MySqlHook(mysql_conn_id='mysql_connection_3')  # Use your connection ID here
    connection = mysql_hook.get_conn()
    cursor = connection.cursor()
    
    # Query to get data from MySQL table
    query = "SELECT * FROM sales_orders"  # Change with your table name and query
    ...
    bucket_name = 'complex-sales'  # MinIO bucket name
    object_name = 'sale-orders.parquet'  # Path in the MinIO bucket
